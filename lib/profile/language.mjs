/**
 * Output language helpers — extracted from profile-language.mjs facade.
 */
...
/** Parse from an already-loaded profile object. */
export function outputLanguageFromProfile(profile) {
  return normalizeOutputLanguage(profile?.language?.output);
}
...
export { DEFAULT_OUTPUT_LANGUAGE, normalizeOutputLanguage };
